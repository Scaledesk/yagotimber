 ...
 */
/**
 * Yagostudio comments resource collection model
 *
 * @category    StarGenius
 * @package     StarGenius_Yagostudio
 * @author      Ultimate Module Creator
 */
class StarGenius_Yagostudio_Model_Resource_Yagostudio_Comment_Yagostudio_Collection extends StarGenius_Yagostudio_Model_Resource_Yagostudio_Collection
{
    /**
     * Entities alias
     *
    ...
    protected function _construct()
    {
        ...
        $this->_commentStoreTable = Mage::getSingleton('core/resource')
            ->getTableName('stargenius_yagostudio/yagostudio_comment_store');
    }
    ...
    {
        $this->getSelect()->where('ct.yagostudio_id = ?', $entityId);
        return $this;
    }
    ...
    protected function _joinFields()
    {
        $commentTable = Mage::getSingleton('core/resource')
            ->getTableName('stargenius_yagostudio/yagostudio_comment');
        $this->getSelect()->join(
            array('ct' => $commentTable),
            'ct.yagostudio_id = main_table.entity_id',
            array(
                'ct_title'      => 'title',
