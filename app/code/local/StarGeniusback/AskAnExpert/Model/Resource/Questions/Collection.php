 ...
 */
class StarGenius_AskAnExpert_Model_Resource_Questions_Collection extends Mage_Core_Model_Resource_Db_Collection_Abstract
{
     ...
     * @return StarGenius_AskAnExpert_Model_Resource_Questions_Collection
     * @author Ultimate Module Creator
     */
    ...
    protected function _renderFiltersBefore()
    {
        if ($this->getFilter('store')) {
            $this->getSelect()->join(
                array('store_table' => $this->getTable('stargenius_askanexpert/questions_store')),
                'main_table.entity_id = store_table.questions_id',
                array()
            )
