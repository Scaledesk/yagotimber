...
$tempcontent=Mage::app()->getStore()->getConfig('mgkautocompletesection/general/tempcontent');
 ...
 $query = Mage::helper('catalogSearch')->getQuery(); 
	...
	$_helper = Mage::helper('catalog/output');
	    ...
	    $html.= '<div class="magik_head">No results found</div>';	
            $html.= '</ul>';			
            return $html;
        }		
	...
	if($flag==1)
		$html .=  '<div class="magik_link"><a href='.$this->getUrl('catalogsearch/result').'?q='.$query->getQueryText().'>View all search result</a></div>';	
